...
class RecipientTest extends TestCase
{
    public function test_national_recipient_id_type_is_ifz(): void
    {
        ...
        $this->assertEquals(Recipient::VAT_ID_TYPE_IFZ, $receptor->vatIdType());
    ...
    {
        $receptor = Recipient::createGenericRecipient('abcdefghijkl', 'Test foreign business', (string) 48260, Recipient::VAT_ID_TYPE_PASSPORT, 'UK');

        $this->assertEquals(Recipient::VAT_ID_TYPE_PASSPORT, $receptor->vatIdType());
